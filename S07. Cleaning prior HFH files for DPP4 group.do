...
use af_dpp4_priorhfhospi.dta
gen dof= dofc(DPP4FillTime)
gen admin= dofc(AdmitDateTime)
gen HFH = 1 
keep scrssn dof admin HFH
duplicates drop scrssn, force 
save "P:\ORD_Sundaram_202108013D\Padmini\Diabetes Stata Files\SGLT2 new files AF\dpp4\diabetes_af_dpp4_HFH.dta", replace 
*** 250 patients 
...
**** 250 patients with prior HFH
save "P:\ORD_Sundaram_202108013D\Padmini\Diabetes Stata Files\SGLT2 new files AF\dpp4\diabetes_af_dpp4_prior_HFH.dta", replace 
